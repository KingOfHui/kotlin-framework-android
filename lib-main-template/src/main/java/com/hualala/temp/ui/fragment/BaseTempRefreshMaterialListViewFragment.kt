...
abstract class BaseTempRefreshMaterialListViewFragment<T : BasePresenter<*>>
    ...
    override fun initView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?) = inflater.inflate(R.layout.fragment_base_refresh_material, container, false)
