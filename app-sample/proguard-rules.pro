...
# and specify the fully qualified class settleName to the JavaScript interface
# class:
...
# hide the original source file settleName.
...
# current app
-keep public class　com.hualala.quickpay.data.** { *; }
