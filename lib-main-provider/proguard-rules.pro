...
# bugly
-keep class com.hualala.base.common.BaseApplication {*;}
-keep class com.hualala.base.common.BaseApplicationLike {*;}
...
# 本工程实体类
-keep public class　com.hualala.provider.common.data.** { *; }